<div>
    <div class="t-card">
        ...
        <div class="t-card-header">
            <center><strong>
                    <h1 class="text-3xl mb-5" style="color: black">Edit Author Information</h1>
                </strong></center>
        </div>
        @else        
        <div class="t-card-header">
            <center><strong>
                    <h1 class="text-3xl mb-5" style="color: black">Create Author Information</h1>
                </strong></center>
        </div>
        @endif
        ...
        <div class="">
            <div class="mx-auto w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-md sm:p-6 md:p-8">
                <div class="mb-6">
                    ...
                    <input type="text" id="author-name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model.lazy="author.author_name" required>
                </div>
                <div class="mb-6">
                    <label for="author-email" class="block mb-2 text-sm font-medium text-gray-900 ">Author E-mail</label>
                    <input type="text" id="author-email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model.lazy="author.author_email" required>
                </div>
                <div class="mb-6">
                    <label for="author-address" class="block mb-2 text-sm font-medium text-gray-900 ">Author Address</label>
                    <input type="text" id="author-address" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model.lazy="author.author_address" required>
                </div>
                <div class="mb-6">
                    <label for="author-phone" class="block mb-2 text-sm font-medium text-gray-900 ">Author Phone</label>
                    <input type="text" id="author-phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model.lazy="author.author_phone" required>
                </div>
